  ...
  constructor(
    ...
    if (this.type === 'AC') {
      ...
      if (this.vehicle === 'EV') {
        ...
        this.busImage = 'assets/bus_blue.png';
      }
    } else if (this.type === 'Ordinary') {
      if (this.vehicle === 'EV') {
        this.busImage = 'assets/bus_green_.png';
      } else {
        this.busImage = 'assets/bus_pink.png';
      }
    } else {
      this.busImage = this.vehicle === 'EV' ? 'assets/bus_green_.png' : 'assets/bus_white_.png';
    }
